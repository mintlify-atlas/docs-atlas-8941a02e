...
<CardGroup cols={2}>
  ...
  <Card title="Persistence" icon="database" href="/architecture/infrastructure-layer">
  ...
  <Card title="CQRS Structure" icon="arrows-split-up-and-left" href="/architecture/application-layer">
